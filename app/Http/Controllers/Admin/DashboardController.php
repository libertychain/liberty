...
class DashboardController extends MainAdminController
{
    ...
    { 
            ...
            return view('admin.pages.dashboard',compact('page_title','users','language','genres','movies','series','sports','plan','transactions','daily_amount','weekly_amount','monthly_amount','yearly_amount','plan_list'));
