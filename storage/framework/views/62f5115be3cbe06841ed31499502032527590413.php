...
<div class="vfx_banner_slider-area text-white">
  <div id="vfx_banner_slider" class="owl-carousel vfx_banner_slider">
    ...
    <a class="" href="<?php echo e($slider_data->slider_url); ?>">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 col-md-8"> 
                <h2 class="banner-title"><a href="<?php echo e($slider_data->slider_url); ?>"><?php echo e($slider_data->slider_title); ?></a></h2>
               </div>
            </div>
          </div>
        </div>
          ...
          <div class="vfx_video_item">
            <div class="vfx_upcomming_item_block"> 
              ...
              <?php endif; ?>  
                ...
                <img class="img-responsive" src="<?php echo e(URL::to('upload/source/'.recently_watched_info($watched_videos->video_type,$watched_videos->video_id)->video_image)); ?>" alt="show">
              </a>        
            </div> 
          </div>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\laravel6_video_script\resources\views/pages/index.blade.php ENDPATH**/ ?>