<?php $__env->startSection('head_title', $movies_info->video_title.' | '.getcong('site_name')); ?>
					...
					<div class="single-section col-md-8 col-sm-12 col-xs-12">
					  <main>
						...
						<?php elseif($movies_info->video_type=="URL"): ?>
						  <div id="container">                   
							<video id="v_player" class="video-js vjs-big-play-centered skin-blue" controls preload="none" width="640" height="450" poster="<?php echo e(URL::to('upload/source/'.$movies_info->video_image)); ?>" data-setup="{}">
						...
						<div class="playlist_item">
						  <a href="<?php echo e(URL::to('movies/'.$latest_movies_data->video_slug.'/'.$latest_movies_data->id)); ?>">
							...
							<div class="playlist_content">
							  <h3><?php echo e(Str::limit($latest_movies_data->video_title,25)); ?></h3>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\laravel6_video_script\resources\views/pages/movies_single.blade.php ENDPATH**/ ?>