<?php $__env->startSection('head_title', $sports_info->video_title.' | '.getcong('site_name') ); ?>
				  ...
				  <div class="row">                    
					<div class="single-section col-md-8 col-sm-12 col-xs-12">
					  <main>
						...
						<div id="container">                   
							<video id="v_player" class="video-js vjs-big-play-centered skin-blue" controls preload="none" width="640" height="450" poster="<?php echo e(URL::to('upload/source/'.$sports_info->video_image)); ?>" data-setup="{}">
					  ...
					  <h3 class="vfx_video_title"><?php echo e($sports_info->video_title); ?></h3> 
					  ...
					  <div class="single-section video-entry mr-top-30" id="episodes_all">
						  ...
						  <div class="section-content">
							<?php if(strlen($sports_info->video_description) > 200): ?>
						...
						<div class="playlist_item">
						  <a href="<?php echo e(URL::to('sports/'.$latest_sports_data->video_slug.'/'.$latest_sports_data->id)); ?>">
							...
							<div class="playlist_content">
							  <h3><?php echo e(Str::limit($latest_sports_data->video_title,25)); ?></h3>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\laravel6_video_script\resources\views/pages/sports_single.blade.php ENDPATH**/ ?>