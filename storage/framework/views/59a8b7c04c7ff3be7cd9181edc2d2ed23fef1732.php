...
<!--
<?php if(\Request::route()->getName()=='episodes_single' OR \Request::route()->getName()=='movies_single' OR \Request::route()->getName()=='sports_single'): ?>
<link rel="stylesheet" href="<?php echo e(URL::asset('site_assets/css/demo.css')); ?>">
<?php endif; ?>-->
...
<body <?php if(\Request::is('login') or \Request::is('signup') or \Request::is('password/email')): ?> class="vfx_account_page" <?php endif; ?>>
...
<!--
<?php if(\Request::route()->getName()=='episodes_single' OR \Request::route()->getName()=='movies_single' OR \Request::route()->getName()=='sports_single'): ?>
<script src="<?php echo e(URL::asset('site_assets/js/plyr.js')); ?>"></script>
...
</html><?php /**PATH G:\xampp\htdocs\laravel6_video_script\resources\views/site_app.blade.php ENDPATH**/ ?>