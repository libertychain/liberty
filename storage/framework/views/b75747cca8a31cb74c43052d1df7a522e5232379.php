    ...
    <div class="modal-dialog">
       <div class="modal-content">
        ...
        <div class="modal-body">
          <p>You don't have access to premimum content kindly purchase subscription to watch this content or <a href="<?php echo e(URL::to('login')); ?>" style="text-transform: uppercase;"><?php echo e(trans('words.login_text')); ?></a> with premium account.</p>
        </div>
...
</footer><?php /**PATH G:\xampp\htdocs\laravel6_video_script\resources\views/_particles/footer.blade.php ENDPATH**/ ?>