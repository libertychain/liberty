      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <a href="<?php echo e(URL::to('admin/subscription_plan')); ?>">
                        <div class="card-box widget-user">
                            <div class="text-center">
                                <h2 class="text-danger" data-plugin="counterup"><?php echo e($plan); ?></h2>
                                <h5 style="color: #343a40;"><?php echo e(trans('words.subscription_plan')); ?></h5>
                            </div>
                        </div>
                        </a>
                    </div>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\laravel6_video_script\resources\views/admin/pages/dashboard.blade.php ENDPATH**/ ?>