    ...
    <div class="modal-dialog">
       <div class="modal-content">
        ...
        <div class="modal-body">
          <p>You don't have access to premimum content kindly purchase subscription to watch this content or <a href="{{ URL::to('login') }}" style="text-transform: uppercase;">{{trans('words.login_text')}}</a> with premium account.</p>
        </div>
