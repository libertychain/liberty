                            ...
                            <div class="col-sm-8">
                                <div class="bg-picture card-box">
                                    ...
                                    <div class="profile-info-name">
                                        ...
                                        @if($user->user_image)
                                          <img src="{{ URL::asset('upload/'.Auth::User()->user_image) }}" class="img-thumbnail" alt="profile_img" style="width: 155px">
                                        @else  
                                          <img src="{{ URL::asset('site_assets/images/avatar.jpg') }}" class="img-thumbnail" alt="profile_img" style="width: 155px">
                                        @endif
