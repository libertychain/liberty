          ...
          <div class="row">
            <div class="col-xl-8">
              <div class="card-box">
                ...
                {!! Form::open(array('url' => 'admin/verify_purchase','class'=>'form-horizontal','name'=>'profile_form','id'=>'profile_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                       <input type="email" name="buyer_email" value="{{env('BUYER_EMAIL')}}" class="form-control">
                    </div>
                  </div> 
