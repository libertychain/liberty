          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="col-md-3">
                  <a href="{{URL::to('admin/sports/add_video')}}" class="btn btn-success btn-md waves-effect waves-light m-b-20" data-toggle="tooltip" title="{{trans('words.add_video')}}"><i class="fa fa-plus"></i> {{trans('words.add_video')}}</a>
                </div>
              </div>
                  ...
                  <tbody>
                   @foreach($video_list as $i => $video_data)
                    <tr>
                      ...
                      <td>@if(isset($video_data->video_image)) <img src="{{URL::to('upload/thumbs/'.$video_data->video_image)}}" alt="video image" class="thumb-lg bdr_radius"> @endif</td>
