...
<div class="vfx_banner_slider-area text-white">
  <div id="vfx_banner_slider" class="owl-carousel vfx_banner_slider">
    ...
    <a class="" href="{{$slider_data->slider_url}}">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 col-md-8"> 
                <h2 class="banner-title"><a href="{{$slider_data->slider_url}}">{{$slider_data->slider_title}}</a></h2>
               </div>
            </div>
          </div>
        </div>
          ...
          <div class="vfx_video_item">
            <div class="vfx_upcomming_item_block"> 
              ...
              @endif  
                ...
                <img class="img-responsive" src="{{URL::to('upload/source/'.recently_watched_info($watched_videos->video_type,$watched_videos->video_id)->video_image)}}" alt="show">
              </a>        
            </div> 
          </div>
