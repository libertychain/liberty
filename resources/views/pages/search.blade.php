...
<div class="page-header">
 ...
 <div class="main-wrap">
  @if(count($movies_list)>0 OR count($series_list)>0 OR count($sports_video_list)>0)     
  ...
  @else
     <h3 style="text-align: center;padding-top: 25px;padding-bottom: 26px;color:#eb1536;">No Search Found</h3>
  @endif
