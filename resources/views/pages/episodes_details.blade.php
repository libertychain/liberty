...
@section('head_title', $series_name.' '.$season_name.' '.$episode_info->video_title.' | '.getcong('site_name'))
				...
				<div class="vfx_video_detail xs-top-40">
					...
					<div class="single-section col-md-8 col-sm-12 col-xs-12">
					  <main>
						...
						<div id="container">                   
							<video id="v_player" class="video-js vjs-big-play-centered skin-blue" controls preload="none" width="640" height="450" poster="{{URL::to('upload/source/'.$episode_info->video_image)}}" data-setup="{}">
