...
@section('head_title', $sports_info->video_title.' | '.getcong('site_name') )
				  ...
				  <div class="row">                    
					<div class="single-section col-md-8 col-sm-12 col-xs-12">
					  <main>
						...
						<div id="container">                   
							<video id="v_player" class="video-js vjs-big-play-centered skin-blue" controls preload="none" width="640" height="450" poster="{{URL::to('upload/source/'.$sports_info->video_image)}}" data-setup="{}">
					  ...
					  <h3 class="vfx_video_title">{{$sports_info->video_title}}</h3> 
						...
						<div class="playlist_item">
						  <a href="{{ URL::to('sports/'.$latest_sports_data->video_slug.'/'.$latest_sports_data->id) }}">
							...
							<div class="playlist_content">
							  <h3>{{Str::limit($latest_sports_data->video_title,25)}}</h3>
